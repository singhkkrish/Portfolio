export const projects = [
  ...
  { id: "02", title: "TraceIt", year: "2025", type: "Lost & found platform", description: "A full-stack platform designed to make the stressful, human task of recovering lost items feel simple and trustworthy.", stack: ["React", "Node.js", "Express", "MongoDB", "JWT"], live: "https://traceit-frontend.onrender.com", repo: "https://github.com/singhkkrish/TRACEIT", image: "/project-previews/traceit.png", color: "lime" },
